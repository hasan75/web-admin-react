...
<div style={{padding:'0px 50px'}} class="mb-3">
 ...
 <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="SSID"/>
</div> 
<div style={{padding:'0px 50px'}} class="mb-3">
...
<div style={{padding:'0px 50px'}} class="mb-3">
 <label  for="exampleFormControlInput1" class="form-label">Return Reason</label>
 <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Return Reason"/>
</div> 
<div style={{padding:'0px 50px'}} class="mb-3">
...
<div style={{padding:'0px 50px'}} class="mb-3">
 <label for="exampleFormControlInput1" class="form-label">Device Serical Number</label>
 <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Device Serical Number"/>
</div> 
...
<div style={{padding:'0px 50px'}} class="mb-3">
 ...
 <div style={{padding:'0px 50px'}} class="mb-3">
 <label for="exampleFormControlInput1" class="form-label">Reception Status</label>
 <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Reception Status"/>
</div> 
 <div style={{padding:'0px 50px'}} class="mb-3">
 <label for="exampleFormControlInput1" class="form-label">Reception Date</label>
 <input type="date" class="form-control" id="exampleFormControlInput1" />
</div>
 <div style={{padding:'0px 50px'}}>
 <label for="exampleFormControlInput1" class="form-label">Shipping Method</label>
 <select class="form-select" aria-label="Default select example">
 <option selected>Select Option</option>
